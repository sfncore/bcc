...
type SyncHandler$1 = (this: WalkerContext$1, node: Node$2, parent: Node$2 | null, key: string | number | symbol | null | undefined, index: number | null | undefined) => void;
//#endregion
...
type AsyncHandler$1 = (this: WalkerContext, node: Node$1, parent: Node$1 | null, key: string | number | symbol | null | undefined, index: number | null | undefined) => Promise<void>;
//#endregion
 ...
 * @returns {Node | null}
 */
declare function walk(ast: Node, {
  enter,
  leave
}: {
  enter?: SyncHandler;
 ...
 */
declare function asyncWalk(ast: Node, {
  enter,
  leave
}: {
  enter?: AsyncHandler;
